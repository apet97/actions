...
class LogServiceTest {
    ...
    void getWidgetStats_calculatesCorrectly() {
        ...
        when(executionLogRepository.countWidgetStats(eq(WORKSPACE_ID), any(Instant.class)))
                .thenReturn(new WidgetStatsRow(100L, 10L));
    ...
    void getWidgetStats_zeroExecutions_returns100PercentSuccess() {
        ...
        when(executionLogRepository.countWidgetStats(eq(WORKSPACE_ID), any(Instant.class)))
                .thenReturn(new WidgetStatsRow(0L, 0L));
    ...
    void getWidgetStats_allFailures_returnsZeroPercent() {
        ...
        when(executionLogRepository.countWidgetStats(eq(WORKSPACE_ID), any(Instant.class)))
                .thenReturn(new WidgetStatsRow(50L, 50L));
