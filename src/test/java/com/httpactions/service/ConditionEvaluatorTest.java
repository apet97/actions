...
class ConditionEvaluatorTest {
    ...
    class ExecutionConditions {
        ...
        void evaluateExecution_nullConditions_returnsTrue() {
            ...
            assertTrue(evaluator.evaluateExecutionConditions(null, event));
        }
        ...
        @Test
        void evaluateExecution_invalidJson_returnsTrue() {
            JsonObject event = new JsonObject();
            event.addProperty("description", "test");

            assertTrue(evaluator.evaluateExecutionConditions("{not valid json!!", event));
        }
    ...
    class SuccessConditions {
        ...
        void evaluateSuccess_noConditions_defaultsTo2xxCheck() {
            ...
            assertTrue(evaluator.evaluateSuccessConditions(null, successResult));
            assertFalse(evaluator.evaluateSuccessConditions(null, failResult));
        }
