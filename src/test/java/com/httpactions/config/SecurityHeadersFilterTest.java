...
class SecurityHeadersFilterTest {
    ...
    @Test
    void staticAsset_skipsFrameOptionsAndCsp() throws ServletException, IOException {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/css/widget.css");
        request.setRequestURI("/css/widget.css");
        MockHttpServletResponse response = new MockHttpServletResponse();
