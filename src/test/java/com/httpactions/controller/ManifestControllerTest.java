...
class ManifestControllerTest {
    ...
    void getManifest_usesLeastPrivilegeScopes() throws Exception {
        ...
        mockMvc.perform(get("/manifest"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.scopes", hasSize(16)))
                .andExpect(jsonPath("$.scopes", hasItem("PROJECT_WRITE")))
                .andExpect(jsonPath("$.scopes", hasItem("TASK_WRITE")))
                .andExpect(jsonPath("$.scopes", hasItem("TAG_WRITE")))
                .andExpect(jsonPath("$.scopes", hasItem("GROUP_WRITE")))
                .andExpect(jsonPath("$.scopes", hasItem("CLIENT_WRITE")))
                .andExpect(jsonPath("$.scopes", hasItem("TIME_ENTRY_WRITE")))
                .andExpect(jsonPath("$.scopes", hasItem("INVOICE_WRITE")))
                .andExpect(jsonPath("$.scopes", hasItem("CUSTOM_FIELDS_READ")))
                .andExpect(jsonPath("$.scopes", hasItem("CUSTOM_FIELDS_WRITE")))
