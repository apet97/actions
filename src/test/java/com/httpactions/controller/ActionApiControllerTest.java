...
class ActionApiControllerTest {
    ...
    private ActionResponse sampleActionResponse() {
        ...
        resp.setName("Test Action");
        resp.setEventType(EventType.NEW_TIME_ENTRY);
        resp.setHttpMethod(HttpMethod.POST);
        resp.setUrlTemplate("https://example.com/hook");
        resp.setRetryCount(3);
    ...
    void listActions_validToken_returnsActions() throws Exception {
        ...
        ActionResponse action1 = sampleActionResponse();
        action1.setName("Slack Notification");
        ActionResponse action2 = sampleActionResponse();
        action2.setName("Discord Webhook");
    ...
    @Test
    @DisplayName("Create action with valid request returns 200")
    void createAction_validRequest_returns200() throws Exception {
        when(tokenService.verifyAndParseClaims(VALID_TOKEN)).thenReturn(validClaims());

        ActionResponse created = sampleActionResponse();
        created.setName("New Webhook Action");
    ...
    void updateAction_validRequest_returns200() throws Exception {
        ...
        ActionResponse updated = sampleActionResponse();
        updated.setId(actionId);
    ...
    @Test
    @DisplayName("Delete action returns 200")
    void deleteAction_returns200() throws Exception {
        UUID actionId = UUID.randomUUID();
        when(tokenService.verifyAndParseClaims(VALID_TOKEN)).thenReturn(validClaims());
