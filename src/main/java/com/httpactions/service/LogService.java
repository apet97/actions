...
public class LogService {
    ...
    public WidgetStats getWidgetStats(String workspaceId) {
        ...
        long totalExecutions24h = executionLogRepository.countByWorkspaceIdAndExecutedAtAfter(workspaceId, since);
        long failedExecutions24h = executionLogRepository.countByWorkspaceIdAndSuccessAndExecutedAtAfter(
                workspaceId, false, since);
